                     ...
                     <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <li>
                                <a href = "retainedEarnings.php">RetainedEarning</a>
                            </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
